			...
			save() {
				...
				this.$http[method](url, this.form)
					.then((res) => {
						...
						this.$set(window.FREELANCERHQ.currency, 'code', this.form.currency_code)
						this.$set(window.FREELANCERHQ.currency, 'precision', this.form.currency_precision)
						this.$set(window.FREELANCERHQ.currency, 'decimal_separator', this.form.decimal_separator)
						this.$set(window.FREELANCERHQ.currency, 'thousands_separator', this.form.thousands_separator)
						this.$set(window.FREELANCERHQ.currency, 'placement', this.form.placement)
