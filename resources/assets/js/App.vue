    ...
    <div class="navbar">
      <div class="navbar-inner">
        ...
        <div class="navbar-brand">
            <img src="../img/freelancerhq.png" class="navbar-logo">
        </div>
  ...
  export default {
    computed: {
      links() {
        ...
        const available = window.FREELANCERHQ.links || []
    ...
    data() {
      return {
        user: window.FREELANCERHQ.user,
        sm: 0
      }
    },
    created() {
      let found = localStorage.getItem('freelancerhq.sm')
    ...
    methods: {
      toggleMenu() {
        ...
        localStorage.setItem('freelancerhq.sm', (this.sm))
      }
    }
  }
</script>